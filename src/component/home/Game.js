...
const Game = ({image, title, description, resize}) => {
    return (
      <li className='flex flex-col items-center justify-center laptop:basis-1/3 max-w-[368px] tablet:max-w-[528px]'>
        <div className={`${resize ? "w-[133px]" :"w-[63px]"} h-[70px] mb-6 relative`}>
          <Image src={image} fill alt="Pesentation Icon"/>
        </div>
