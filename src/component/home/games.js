...
<h1 className='text-24 mb-6 tablet:text-32 tablet:mb-[40px] laptop:mb-[70px] font-bold w-[288px] tablet:w-[441px] laptop:w-[690px] mx-auto'>How our game works</h1>

      <ul className='flex flex-col gap-5 tablet:gap-[40px] items-center laptop:flex-row laptop:items-start laptop:gap-8 text-center'>
