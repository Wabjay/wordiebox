  ...
  setVisibility(true)
    ...
    const content : ReactElement = (
        <div className="text-center mt-[60px] tablet:mt-20 laptop:mt-[120px] desktop:mt-20">
          <h1 className="text-14 tablet:text-32 font-bold mb-4">Improve your word vocabulary</h1>
          ...
          <p  onClick={display} className="w-fit mx-auto bg-[#FFF5C4] border-[#1C1C1C] border shadow-darkbox py-3 px-4 text-16 font-medium focus:outline-none">How to play the game</p>
        </div>
      );
  return content
}
