...
console.log(pathname)
    ...
    const Menus = [
        { title: "Dashboard", src: Dash, link: '/dashboard' },
        { title: "Referrals", src: Referrals, link: '/'},
        { title: "Word history", src: History, link: '/' },
        { title: "Leaderboard", src: Leaderboard, link: '/' },
        { title: "Settings", src: Settings, link: '/' },
      ];
